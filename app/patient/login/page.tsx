  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] relative flex items-center justify-center py-12 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-10%] right-[-5%] w-100 h-100 bg-blue-100/40 rounded-full blur-[100px]" />
        <div className="absolute bottom-[-10%] left-[-5%] w-100 h-100 bg-emerald-100/40 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-white/90 backdrop-blur-3xl rounded-[3rem] shadow-[0_40px_80px_-20px_rgba(15,23,42,0.15)] p-10 sm:p-12 border border-white/50">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 font-medium mt-2 text-sm">Sign in to access your healthcare account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <Link href="/patient/forgot-password" className="text-[10px] font-black text-blue-600 uppercase tracking-wider hover:text-blue-700 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-16 pr-14 py-5 bg-white border-2 border-slate-100 rounded-3xl text-slate-900 placeholder:text-slate-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none font-bold shadow-sm"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-5 bg-blue-600 hover:bg-blue-700 text-white rounded-4xl font-black shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-3 disabled:opacity-50 group cursor-pointer mt-2"
            >
              {loading ? (
          ...
          <div className="mt-8 pt-8 border-t border-slate-100 text-center">
            <p className="text-slate-500 font-medium text-sm">
              ...
              <Link href="/patient/register" className="text-blue-600 hover:text-blue-700 font-black transition-colors border-b-2 border-blue-600/20 hover:border-blue-600">
                Create Account
              </Link>
            </p>
          </div>
